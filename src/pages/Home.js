    ...
    return (
        <div className="flex">
            ...
            </div>
            {
                ...
                </div> : <div className="flex w-[80vw] h-[100vh]  justify-center items-center text-4xl font-semibold text-center"> Please Connect your wallet <br /> to view content </div>
            }
