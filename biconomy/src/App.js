...
let domainData = {
  ...
  verifyingContract:"0x852514433D31823DA95615bB02451B2714FF3235", //contract address
...
function App() {
  ...
  useEffect(()=>{
    ...
    let biconomy = new Biconomy(maticProvider,{apiKey:"MkQcRa1Ow.4a8e9ad9-e7a6-4231-b5fc-280af59dfdf6"});
    ...
    biconomy.onEvent(biconomy.READY, async () => {
      ...
      const newContract = new web3.eth.Contract(abi,0x852514433D31823DA95615bB02451B2714FF3235);
